...
export const SEED_LEDGERS: Ledger[] = [
  ...
  // Set Opening Outstanding Creditors to balance ledger movements to exactly ₹1,36,450 closing
  { id: 'l-liab-creditors', groupId: 'g-current-liab', name: 'Outstanding Creditors for Purchase (लेनदार बकाया)', code: '2002', type: 'LIABILITY', openingBalance: 163346, currentBalance: 163346 },
